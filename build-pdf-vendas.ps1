...
$mdDir = "C:\Users\Adm\Documents\Projetos\04 - TikTok\O Cara Testou\produtos\cysedoya-jump-starter-compressor\roteiros\vendas"
$outDir = "C:\Users\Adm\Documents\Projetos\04 - TikTok\O Cara Testou\produtos\cysedoya-jump-starter-compressor\roteiros"
$outFile = Join-Path $outDir "100-roteiros-vendas-COMPLETO.html"
...
Write-Host "=== Gerando PDF consolidado dos 100 roteiros de vendas ===" -ForegroundColor Yellow
Write-Host "Lendo arquivos MD..." -ForegroundColor Cyan
...
<title>100 Roteiros de Vendas | O CARA TESTOU</title>
<style>$pageStyles</style>
</head>
<body>
<div class="cover">
    <h1>O CARA TESTOU</h1>
    <h2>100 Roteiros de Vendas</h2>
    <p>Conteudo de Vendas (A9) &mdash; Estrutura oficial de 7 etapas<br>Cysedoya Jump Starter Q18B</p>
    <div class="by">100 videos &middot; 60s cada</div>
</div>
"@
...
Write-Host "  1. Abra o arquivo HTML no Chrome/Edge" -ForegroundColor White
Write-Host "  2. Ctrl+P (Imprimir)" -ForegroundColor White
Write-Host "  3. Selecione 'Salvar como PDF'" -ForegroundColor White
Write-Host "  4. Ative 'Imprimir imagens de fundo' nas opcoes" -ForegroundColor White
Write-Host "  5. Salve como '100-roteiros-vendas.pdf'" -ForegroundColor White
